...
import { ToggleTypeOneIdTransactionController } from "../modules/transactions/useCases/toggleTypeOneIdTransaction/toggleTypeOneIdTransactionController";
...
transactionRouter.patch("/toggleTypeOne/:id", new ToggleTypeOneIdTransactionController().handle);
